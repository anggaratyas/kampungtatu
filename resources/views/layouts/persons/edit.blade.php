    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">                        
                <h3 class="panel-title">Edit Data Penduduk Metatu</h3>
      ...
      @endif
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="/people/{{ $people->id }}">
                            @method('patch')
                            @csrf                      
                                        ...
                                        <div class="tab-pane active" id="tab-data-diri">
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                                                                                                                                        
                                                    <input type="text" class="form-control" name="nama_lengkap" value="{{ $people->nama_lengkap }}"/>                                                    
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                            
                                                    <input type="text" class="form-control" name="nik" value="{{ $people->nik }}"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                            
                                                    <input type="text" class="form-control" name="kk" value="{{ $people->kk }}"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                            
                                                    <input type="text" class="form-control" name="tlp" value="{{ $people->tlp }}"/>
                                                </div>
                                            </div>  
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                            
                                                    <input type="text" class="form-control" name="tempat_lahir" value="{{ $people->tempat_lahir }}"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input name="tgl_lahir" type="text" class="form-control datepicker" value="{{ $people->tgl_lahir }}"/>                                            
                                                    </div>
                                          ...
                                          <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12"> 
                                                    <select name="jenis_kel" class="form-control select" >
                                                        <option>{{ $people->jenis_kel }}</option>
                                                <option>L</option>
                                                <option>P</option>
                                                    </select>
                                                </div>
                            ...
                            <option>Kong Hu Cu</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">    
                                                <select name="skul" class="form-control select" data-live-search="true" value="{{ $people->skul }}">
                                                <option>{{ $people->skul }}</option>
                            ...
                            <option>Strata 3</option>
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                            
                                                    <input type="text" class="form-control" name="ibu" value="{{ $people->ibu }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                            
                                                    <input type="text" class="form-control" name="ayah" value="{{ $people->ayah }}" />
                                                </div>
                                            </div>                                        
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                <select name="kwn" class="form-control select" value="{{ $people->kwn }}" >
                                                <option>{{ $people->kwn }}</option>
                                                <option>WNI</option>
                                                <option>WNA</option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="tab-pane" id="tab-alamat">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                                                                                                                                        
                                                    <input type="text" class="form-control" name="alamat" value="{{ $people->alamat }}" />                                                    
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-xs-3">                                            
                                                  <label>RT</label>
                                                  <input name="rt" type="text" class="form-control" value="{{ $people->rt }}" />
                                                </div>
                                                <div class="col-md-3 col-xs-3">                                            
                                                    <label>RW</label>
                                                  <input name="rw" type="text" class="form-control" value="{{ $people->rw }}"/>
                                                </div>
                                            </div>
                                    ...
                                    <div class="panel-footer">                                                                        
                                        <button type="/people/create" class="btn btn-primary pull-right">Simpan Perubahan<span class="fa fa-floppy-o fa-right"></span></button>
                                    </div>
                                </div>                                
