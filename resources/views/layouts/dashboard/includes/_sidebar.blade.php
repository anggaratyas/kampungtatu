                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-profile">
                        ...
                        <div class="profile">
                            ...
                            <div class="profile-data">
                                <div class="profile-data-name">aaaa</div>
                    ...
                    <li class="xn-openable">
                        ...
                        <ul>
                            ...
                            <li><a href="{{url('/people')}}"><span class="fa fa-users"></span> Data Penduduk</a></li>
                    ...
                    <li class="xn-openable">
                        ...
                        <ul>
                            ...
                            <li><a href="{{url('/people/create')}}"><span class="fa fa-file-text-o"></span> Register Penduduk</a></li>
